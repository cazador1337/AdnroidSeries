...
import com.example.joao.projectfinal.*;
import com.example.joao.projectfinal.ModifyActivity;
...
public class RootActivity extends AppCompatActivity
    ...
    private com.example.joao.projectfinal.banco.sql.projectfinal.controller.SerieManager manager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.open(getApplicationContext(), com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.DATA_BASE, 1, com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.class);
        listView = (ListView) findViewById(R.id.list_series);
        manager = new com.example.joao.projectfinal.banco.sql.projectfinal.controller.SerieManager(listView, this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_new: {
                Intent intent = new Intent(this, com.example.joao.projectfinal.banco.sql.projectfinal.ModifyActivity.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, com.example.joao.projectfinal.banco.sql.projectfinal.ModifyActivity.class);
        intent.putExtra(com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.ID, manager.get(position));
        startActivityForResult(intent, 0);
    }
}
