package com.example.joao.projectfinal.banco.sql.projectfinal;
...
public class ModifyActivity extends AppCompatActivity {
    private com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie s = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initComponents();
        s = getIntent().getParcelableExtra(com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.ID);
        s = s == null ? new com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie() : s;
        if(s.getId() != -1){
    ...
    private int getStatus(int id){
        ...
        switch (rg.getCheckedRadioButtonId()){
            case R.id.rd_complete:{
                return com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.COMPLETO;
            }
            case R.id.rd_watching:{
                return com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.ASSISTINDO;
            }
            case R.id.rd_plan:{
                return com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.PLANO;
            }
        }
        return -1;
    }
    ...
    private void setStatus(int pos){
        switch (pos){
            case com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.ASSISTINDO:{
                setRadio(R.id.rd_watching, true);
                break;
            }
            case com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.COMPLETO:{
                setRadio(R.id.rd_complete, true);
                break;
            }
            case com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie.PLANO:{
