...
import com.example.joao.projectfinal.banco.core.Manager;
...
public abstract class AbstractModel<T extends Parcelable> {
    ...
    public static com.example.joao.projectfinal.banco.sql.projectfinal.banco.core.Manager manager;
    public static com.example.joao.projectfinal.banco.sql.projectfinal.banco.sql.Settings settings;

    public static void open(Context context, String database, int version, Class<?> type) {
        com.example.joao.projectfinal.banco.sql.projectfinal.banco.sql.Settings settings = new com.example.joao.projectfinal.banco.sql.projectfinal.banco.sql.Settings(database, version, type);
        settings.setContext(context);
        AbstractModel.settings = settings;
        com.example.joao.projectfinal.banco.core.AbstractModel.manager = new Manager(settings);
    }
    ...
    public final void save() {
        try {
            SQLiteDatabase db = com.example.joao.projectfinal.banco.core.AbstractModel.manager.getWritableDatabase();
    ...
    public static class Objects<T extends Parcelable> {
        ...
        public T[] all() {
            SQLiteDatabase db = com.example.joao.projectfinal.banco.core.AbstractModel.manager.getReadableDatabase();
            try {
                Class<?> core = com.example.joao.projectfinal.banco.core.AbstractModel.settings.getCore();
