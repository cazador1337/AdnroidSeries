package com.example.joao.projectfinal.banco.sql.projectfinal.custom;
 ...
 */
public class SeriesAdapter extends ArrayAdapter<com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie> {

    public SeriesAdapter(Context context, int resource, List<com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie> objects) {
        super(context, resource, objects);
    }

    @Override
    public View getView(int position, View row, ViewGroup parent) {
        com.example.joao.projectfinal.banco.sql.projectfinal.models.Serie data = this.getItem(position);
        if (row == null) {
